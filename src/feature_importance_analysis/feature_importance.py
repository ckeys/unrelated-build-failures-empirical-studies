...
data_directory = current_file_path.split("/")[:-3] + ['data', 'modeling_data', 'training','training_with_LOOCV_performance']
...
# csv_files = [file for file in os.listdir(directory_path) if file.endswith("_model_importance.csv")]
...
# project_name_group = ['hive','hadoop','yarn','hdfs','hbase']
# project_name_group = ['hbase']
# Loop through each CSV file and extract top 10 features
...
# Add a new column for hint with rank information
...
# print(pivot_df)
# latex_table = tabulate(pivot_df, tablefmt='pretty', headers='keys')
# print(latex_table)
# print(results_df)
# print("Top 10 features per project saved to 'top_10_features_per_project.csv'")
